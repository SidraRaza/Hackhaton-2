...
const mockUpcomingTasks: TaskApiResponse[] = [
  {
    id: '1',
  ...
  },
  {
    ...
    priority: 'medium',
    status: 'in-progress',
    dueDate: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], // In 5 days
...
export default function UpcomingPage() {
  ...
  const [tasks, setTasks] = useState<TaskApiResponse[]>(mockUpcomingTasks);
      ...
      <main className={`flex-1 transition-all duration-300 ${isSidebarCollapsed ? 'ml-16' : 'ml-64'}`}>
        ...
        <div className="p-6">
          <div className="mb-6 flex justify-between items-center">
            <h1 className="text-2xl font-bold text-foreground">Upcoming Tasks</h1>
