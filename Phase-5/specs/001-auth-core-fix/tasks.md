---
description: "Task list for frontend authentication and dashboard integration"
---

# Tasks: Frontend + Backend Auth Integration

**Input**: Design documents from `/specs/001-auth-core-fix/`
...
- [X] T002 [P] Install backend dependencies: FastAPI, SQLModel, python-jose, better-auth in backend/requirements.txt
- [X] T003 [P] Install frontend dependencies: Next.js 16+, React 19+, Tailwind CSS, Better Auth client in frontend/package.json
